...
/*if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateFilter = ['id' => (int) $packId];
    $updateOptions = ['upsert' => false];

    $updateQuery = new MongoDB\Driver\Query($updateFilter, $updatedData, $updateOptions);
    $manager->executeQuery('ugcall.Pack', $updateQuery);

    // Redirect back to viewonepack.php or wherever you want
    header('Location: viewonepack.php');
    exit;
} */
?>
...
<section class="section main-section">
    <div class="card mb-6">
      <header class="card-header"></header>
		...
		<?php if (isset($packData)): ?>
                <form method="post" action="viewonepack_edit.php?packId=<?php echo $packData->id; ?>">
		<div>
  ...
  <tr>
    ...
    <td width="70%" class="show"><div><input name="packName" type="text" class="input is-static" value="<?php echo $packData->packName; ?>" readonly></div></td>
  </tr>
</table>
		</div>
		<div>
  ...
  <tr>
    ...
    <td width="70%" class="show"><div><input name="duration" type="text" class="input is-static" value="<?php echo $packData->duration; ?>" readonly></div></td>
  </tr>
</table>
		</div>
  ...
  <tr>
    ...
    <td width="70%" class="show"><div><input name="createdWeek" type="text" class="input is-static" value="<?php echo $packData->createdWeek; ?>" readonly></div></td>
  </tr>
</table>
		</div>
		<div>
  ...
  <tr>
    ...
    <td width="70%" class="show"><div><input name="dueDate" type="text" class="input is-static" value="<?php echo $packData->dueDate; ?>" readonly></div></td>
  </tr>
</table>
		</div>
		<div>
  ...
  <tr>
    ...
    <td width="70%" class="show"><div><input name="dueWeek" type="text" class="input is-static" value="<?php echo $packData->dueWeek; ?>" readonly></div></td>
  </tr>
</table>
		</div>
		...
		<table width="100%" border="1">
  <tr>
    <td width="30%" class="show"><div>Pack Current Status :</div></td>
    <td width="70%" class="show"><div><input name="status3" type="text" class="input is-static" value="<?php echo $packData->status; ?>" readonly></div></td>
		...
		<table width="100%" border="1">
  <tr>
    <td width="30%" class="show"><div>Change Pack Status:</div></td>
  ...
  <tr>
    ...
    <td width="70%" class="show"><div><input name="month" type="text" class="input is-static" value="<?php echo $packData->month; ?>" readonly></div></td>
  </tr>
</table>
		</div>
