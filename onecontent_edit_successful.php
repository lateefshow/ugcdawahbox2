    ...
    <div class="card mb-6">
      <header class="card-header"></header>
        <p class="card-header-title button green" style="font-size:40px">
          ...
          <?php echo "Content Has Been Successfully Editted"; ?>
        </p>
		<br>
		<br>
		<hr>
		<div>
		<div align="center">
		<form method="post" action="viewonecontent.php">
    <label for="packId" class="label">Editted Content ID:</label>
