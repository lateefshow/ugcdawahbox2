...
<?php
var_dump($packData); // Add this line to inspect the structure of $packData

if ($packData !== false && property_exists($packData, 'id')) {
    echo '<div class="button blue">Pack ' . $packData->id . ' Successfully Edited</div>';
} else {
    echo '<div class="button red">Error: Pack data not found</div>';
}
?>
